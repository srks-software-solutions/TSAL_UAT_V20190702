            ...
            if (PlantID != 0)
            {
                if (CellID != 0)
                {
                    ...
                    if (WorkCenterID != 0)
                    {
                        ...
                        ViewBag.SelectedPath = plantName.PlantName + " => " + shopName.ShopName + " => " + cellName.CellName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                    ...
                    {
                        ViewBag.SelectedPath = plantName.PlantName + " => " + shopName.ShopName + " => " + cellName.CellName + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                ...
                {
                    ViewBag.SelectedPath = plantName.PlantName + " => " + shopName.ShopName + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                    ViewData["CellID"] = new SelectList(obj.GetCellList1(ShopID, PlantID), "CellID", "CellName", CellID);
                    ...
                    if (WorkCenterID != 0)
                    {
                        var wcName = obj.GettbMachineDet(WorkCenterID);
                        //string wcName = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.MachineID == WorkCenterID).Select(m => m.MachineInvNo).FirstOrDefault();
                        ViewBag.SelectedPath = plantName.PlantName + " => " + shopName.ShopName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                        //ViewData["WorkCenterID"] = new SelectList(db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.PlantID == PlantID && m.ShopID == ShopID && m.IsNormalWC == 0), "MachineID", "MachineInvNo");
                    }
                    else
