    ...
    public class MultiWorkOrderController : Controller
    {
        ...
        public List<int> MWO_OverlapCheckerForPlantDownwards(int plantid, int mwoID = 0)
        {
            ...
            if (overlappingPlanId.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where PlantID = '" + PlantID + "' and ShopID is null and CellID is null and WCID is null and IsDeleted = 0 and MWOID != " + mwoID + " ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where PlantID = '" + PlantID + "' and ShopID is null and CellID is null and WCID is null and IsDeleted = 0 ;";
                }
        ...
        public List<int> MWO_OverlapCheckerForShopDownwards(int shopid, int mwoID = 0)
        {
            ...
            if (overlappingPlanId2.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where ShopID = '" + ShopID + "'  and CellID is null and WCID is null  and IsDeleted = 0 and MWOID != " + mwoID + " ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where ShopID = '" + ShopID + "'  and CellID is null and WCID is null  and IsDeleted = 0 ;";
                }
                SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
                da.Fill(dataHolder);
                mc.close();
        ...
        public List<int> MWO_OverlapCheckerForCellDownwards(int cellid, int mwoID = 0)
        {
            ...
            if (overlappingPlanId.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where CellID = '" + CellID + "' and WCID is null and IsDeleted = 0 and MWOID != " + mwoID + " ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where CellID = '" + CellID + "' and WCID is null  and IsDeleted = 0  ;";
                }
                SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
                da.Fill(dataHolder);
                mc.close();
        ...
        public List<int> MWO_OverlapCheckerForMachineDownwards(int wc, int mwoID = 0)
        {
            ...
            if (mwoID != 0)
            {
                sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where IsDeleted = 0 and MWOID != " + mwoID + " and WCID = '" + WorkCenterID + "' ;";
            }
            else
            {
                sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where IsDeleted = 0 and WCID = '" + WorkCenterID + "' ;";
            }
            SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
            da.Fill(dataHolder);
            mc.close();
        ...
        public List<int> MWO_OverlapCheckerForPlant(int plantid, int mwoID = 0)
        {
            ...
            if (mwoID != 0)
            {
                sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where PlantID = '" + PlantID + "' and ShopID  is null and  CellID  is null and IsDeleted = 0 and MWOID != " + mwoID + " and WCID  is null ;";
            }
            else
            {
                sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where PlantID = '" + PlantID + "' and ShopID  is null and  CellID  is null and IsDeleted = 0 and WCID  is null ;";
            }
            SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
            da.Fill(dataHolder);
            mc.close();
        ...
        public List<int> MWO_OverlapCheckerForShop(int shopid, int mwoID = 0)
        {
            ...
            if (overlappingPlanId.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where ShopID = '" + ShopID + "' and  CellID is null and IsDeleted = 0 and MWOID != " + mwoID + " and WCID  is null ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where ShopID = '" + ShopID + "' and  CellID  is null and IsDeleted = 0 and WCID  is null ;";
                }
                SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
                da.Fill(dataHolder);
                mc.close();
        ...
        public List<int> MWO_OverlapCheckerForCell(int cellid, int mwoID = 0)
        {
            ...
            if (overlappingPlanId.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where CellID = '" + CellID + "' and IsDeleted = 0 and MWOID != " + mwoID + " and WCID is null ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where CellID = '" + CellID + "' and IsDeleted = 0 and WCID is null ;";
                }
                SqlDataAdapter da = new SqlDataAdapter(sql, mc.msqlConnection);
                da.Fill(dataHolder);
                mc.close();
        ...
        public List<int> MWO_OverlapCheckerForMachine(int wc, int mwoID = 0)
        {
            ...
            if (overlappingPlanId2.Count == 0)
            {
                ...
                if (mwoID != 0)
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where IsDeleted = 0 and MWOID != " + mwoID + " and WCID = '" + MachineID + "' ;";
                }
                else
                {
                    sql = "SELECT MWOID FROM i_facility_tsal.dbo.tblmultipleworkorder where IsDeleted = 0 and WCID = '" + MachineID + "' ;";
